    ...
    def post(self):
        ...
        if user_id:
            ...
            if contest_challenge_id:
                ...
                settings_data_ent = ChallengeSettings.query.filter_by(
        challenge_id=challenge_id, language_name = data['language']).first()
    ...
    def post(self):
        ...
        if user_id:
            ...
            output, error, is_correct = get_result_test_case(
                    data['path'], data['code_file_path'],data['input_file'], data['output_file'], data['language'], data["strength"])
